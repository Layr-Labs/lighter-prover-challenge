...
impl BlockCircuit {
    ...
    /// Seeded form of [`Self::witness_inputs_light_chain`] without an intermediate map.
    pub fn seed_witness_light_chain_into<W: WitnessWrite<F>>(
        target: &BlockTarget,
        light_tx_chain_proof: &ProofWithPublicInputs<F, C, D>,
        pw: &mut W,
    ) -> Result<()> {
    ...
    /// Seeded form of [`Self::witness_inputs_heavy_chain`] without an intermediate map.
    pub fn seed_witness_heavy_chain_into<W: WitnessWrite<F>>(
        target: &BlockTarget,
        heavy_tx_chain_proof: &ProofWithPublicInputs<F, C, D>,
        pw: &mut W,
    ) -> Result<()> {
