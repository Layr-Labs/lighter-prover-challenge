...
mod vendored_gate_tests {
    ...
    fn u16_arithmetic_accumulate_matches_default() {
        ...
        crate::gate_batch_testing::assert_accumulate_matches_default(&gate);
    }
    ...
    G: Gate<GoldilocksField, 2>,
{
    ...
    let rand_f = |rng: &mut rand::rngs::ThreadRng| {
    ...
    let vars = || EvaluationVarsBaseBatch::new(n, &constants_batch, &wires_batch, &public_inputs_hash);
