...
impl<F: RichField + Extendable<D>, const D: usize> Gate<F, D> for U16AddManyGate<F, D> {
    ...
    fn eval_unfiltered_base_batch(&self, vars_base: EvaluationVarsBaseBatch<F>) -> Vec<F> {
        ...
        for i in 0..self.num_ops {
            ...
            // Keep the scalar evaluator's descending constraint order while
            // reading each wire and writing each constraint as a contiguous row.
