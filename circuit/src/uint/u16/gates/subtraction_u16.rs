    ...
    for U16SubtractionGenerator<F, D>
{
    ...
    fn run_once(
        ...
        // hand. Only the borrow branch needs it — and note it cannot be folded
        // into `result_initial_u64 + (1 << 16)`, because there `result_initial`
        // is near the modulus and the addition wraps.
