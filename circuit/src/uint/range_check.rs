...
impl<F: RichField + Extendable<D>, const D: usize> Gate<F, D> for RangeCheckGate<F, D> {
    ...
    fn eval_unfiltered_base_batch_accumulate(
        ...
        // stack and fall back to the heap only for oversized batches, matching
        // the sibling uint gates. This gate was the last one still taking a
        // heap allocation on every evaluation batch.
