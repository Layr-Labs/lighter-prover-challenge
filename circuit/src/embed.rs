...
/// scored worker first-exec code-signature validation on a fresh inode, paid
/// once per ranked fixture. Compression runs in the untimed compile job, so
/// the write side can afford a high level: zstd-19 shrinks these sections ~4x
/// against the previous LZ4 encoding.
