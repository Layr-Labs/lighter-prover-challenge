...
// Official redraw marker: the first verified sparse-tree result landed amid
// five adjacent independent 25--26 TPS slow-host measurements. No executable
// behavior changes in this redraw commit.
