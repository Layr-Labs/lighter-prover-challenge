...
/// Same-binary escape hatch for controlled A/B measurements. The optimized path is enabled by
/// default; set `PLONKY2_FFT_WAVEFRONT=0` before process startup to retain the inherited descending
/// cache-block schedule.
#[cfg(all(target_arch = "aarch64", feature = "parallel", feature = "std"))]
#[inline]
