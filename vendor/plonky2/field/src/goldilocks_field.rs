...
impl Field for GoldilocksField {
    ...
    /// both.)
    // Resubmission of 44b5fed5/a1cabc4c: both failed in the 15:30Z fleet-starvation window
    // (runner never assigned, content never evaluated); resubmitted on fleet recovery.
