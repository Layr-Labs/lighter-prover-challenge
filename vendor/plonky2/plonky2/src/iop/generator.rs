...
/// underflow. The `u32` representation matches the checked circuit-build and decode bounds on
/// this count. This is the exact complement of the previous initialization, which instead walked
