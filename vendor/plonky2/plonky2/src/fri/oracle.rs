    ...
    PolynomialBatch<F, C, D>
{
    ...
    pub fn prove_openings(
        ...
        // it without the paired permutation optimization. Redraw 2 requests a
        // fast-host sample after the first official run landed in the stable
        // 25.x-TPS slow-host mode; execution semantics remain unchanged.
