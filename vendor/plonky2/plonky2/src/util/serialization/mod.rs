...
use crate::plonk::circuit_data::{
    CircuitConfig, CircuitData, CommonCircuitData, GeneratorWatchIndex, ProverCircuitData, ProverOnlyCircuitData,
...
pub trait Write {
    ...
    >(
        ...
        self.write_usize(generator_indices_by_watches.entry_count())?;
