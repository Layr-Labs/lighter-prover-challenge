...
#[cfg(all(feature = "std", target_arch = "aarch64", target_os = "macos"))]
pub use metal::{
    is_exclusive_gpu_phase, prepare_final_block_column_stores, prewarm as prewarm_gpu,
...
/// No-op final-phase pool transition on platforms without Metal stores.
#[cfg(not(all(feature = "std", target_arch = "aarch64", target_os = "macos")))]
pub fn prepare_final_block_column_stores(_requested_bytes: [u64; 2]) {}
