...
#[cfg(all(feature = "std", target_arch = "aarch64", target_os = "macos"))]
pub use metal::{
    commit_probe_report, is_exclusive_gpu_phase, prewarm as prewarm_gpu, set_exclusive_gpu_phase,
};

/// Empty on platforms without the Metal backend, where there is nothing to
/// probe.
