// This body is compiled at runtime after being prefixed with the exact
// Goldilocks helpers extracted from poseidon2.metal. Keeping the arithmetic in
// one checked-in source prevents the prebuilt and residual kernels drifting.
