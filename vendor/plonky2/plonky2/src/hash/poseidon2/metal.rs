...
/// (absorb+leaf+parent at 256) rejected at 32.082. Range/U32/Poseidon2-gate
/// quotient kernels stay on [`dispatch`]'s 128 clamp. Default 256 is the
...
/// quotient_rows`). Absorb-only 256 printed 32.973; this bisect unclamps only
/// permutation, leaving range/U32/gate quotients at 128. `LIGHTER_PERM_TG=128`
/// restores the prior clamp.
