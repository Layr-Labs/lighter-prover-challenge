...
/// 96      empty archive or install/context race
/// 97      no Metal device
...
/// The bridge may leave that path absent or install a writable placeholder;
/// create-and-truncate handles both. A full read-back comparison is stronger
/// than a digest check and proves the exact embedded bytes reached the file
/// Metal is about to open.
