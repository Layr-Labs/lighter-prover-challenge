...
/// Diagnostic variant used by the scored benchmark candidate. A missing,
/// incompatible, partial, or unprobeable archive aborts the worker, including
/// failures in the five asynchronous probes. A completed run therefore proves
/// all eleven `FailOnBinaryArchiveMiss` lookups succeeded.
