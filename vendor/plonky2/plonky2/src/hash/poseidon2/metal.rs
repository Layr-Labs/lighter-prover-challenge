...
///
/// Only the width-16 quotient and width-24 Z/partial-products 2^17 heavy trees
/// change route, only while both paths are alive and a light proof is already
/// running, and never in a genuinely exclusive phase. Wide wire trees remain
/// unchanged; Light, pre-execution, final-block, and all transaction trees also
/// retain the promoted routing policy.
