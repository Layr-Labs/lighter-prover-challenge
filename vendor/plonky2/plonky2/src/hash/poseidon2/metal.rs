...
/// The promoted setting lowered 3 -> 1 (any runnable chain step made the spine
/// urgent). This candidate tests the previously unmeasured midpoint 2. The note
...
pub(crate) fn build_merkle_tree_shared_streamed<F: RichField>(
    ...
    for group in 0..groups {
        ...
        let command_buffer = autoreleasepool(|| -> CommandBuffer {
            ...
            // Hash kernels benefit from wider threadgroups than the generic
            // tree kernels on Apple GPUs; the default is tunable for M-series
            // runner revisions without affecting any proof arithmetic.
