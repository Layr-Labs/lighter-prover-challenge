...
/// The tiled Range/U32 kernel's static 136-column allocation is indexed by a
/// 16-row group, the profile-tested full-width shape. Keep the dispatch shape
/// identical to the generated Metal source.
