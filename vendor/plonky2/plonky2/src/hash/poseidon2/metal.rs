...
/// this bisect changes only that kernel. Current-tree M4 ABBA sweeps selected
/// 64 threads: 25.721 s mean versus 25.842 at 128 and 25.864 at 256, matching
/// the earlier independent 64-vs-128 result (-0.58%). Smaller groups preserve
/// more resident work for this register-heavy, memory-latency-bound kernel.
/// `LIGHTER_HASH_TG` remains available for same-binary geometry checks.
