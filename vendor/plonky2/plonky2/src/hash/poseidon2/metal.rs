...
/// Build-host-compiled portable AIR containing a Range/U32 kernel whose first
/// 120 production wire columns are resident in a 32-row, 30 KiB threadgroup
...
/// The tiled Range/U32 kernel's static 120-column allocation holds 32 rows.
/// Every lane in a full SIMDgroup fills and then evaluates one row. Keep this
/// dispatch shape identical to the generated Metal source.
