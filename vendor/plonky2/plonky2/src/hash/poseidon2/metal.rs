...
// Ranked redraw note: submissions 8e4c90a1 and 350a8d69 completed in 97.519 s
// and 97.104 s, matching the independently observed 96-98 s slow-host cluster;
// the executable stays unchanged until a normal-host sample isolates this path.
#[allow(clippy::too_many_arguments)]
