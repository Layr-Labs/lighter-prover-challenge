...
/// `size_of::<F>() == 8`). This includes the standard constants/sigmas width
/// 82 while wider leaves still take the materializing fallback.
const GATHER_MAX_WIDTH: usize = 96;
