...
pub(crate) fn fill_subtree_flat<F: RichField, H: Hasher<F>>(
    ...
    if digests_buf.is_empty() {
        ...
        // join overhead per unit of useful work went up. A sweep of
        // 16/64/128/256 on the public fixture put the minimum at 64, and that
        // value was promoted at 12.4685650512821 before a tree-wide CRLF
        // clobber reverted it.
