...
>(
    ...
    // Degree 14 and 16 both show repeatable, separated gather+evaluation wins
    // at 256 points. Their exact gate differentials include the heap-fallback
    // paths used beyond the 64-point stack scratches. Keep degree 18 at 64:
    // its final recursion/U32 cohort is separate from the measured shapes.
