                    ...
                    for (t, &x) in xs.iter().enumerate() {
                        ...
                        for chunk in 0..num_chunks {
                            ...
                            for j in start..end {
                                ...
                                // Form the shared wire-plus-gamma base once per
                                // challenge and use the field's fused
                                // multiply-accumulate primitive for `base + beta*x`.
                                // This removes two field additions per routed wire
                                // while preserving the exact numerator/denominator
                                // factor and multiplication order.
