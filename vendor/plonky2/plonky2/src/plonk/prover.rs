...
>(
    ...
    if has_gpu_values {
        ...
        // Ranked redraw: 354d0216 verified 5/5 proofs in the recurring slow
        ...
        quotient_values
            ...
            .for_each(|(i, cpu_values)| {
                ...
                // Keep the CPU term divided before adding Metal terms. A
                // distributive common-denominator rewrite passed the public
                // seam test but failed ranked private fixture 01; preserving
                // this reduction/representation order is a proof invariant.
