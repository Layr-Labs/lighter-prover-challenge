...
>(
    ...
    // Marker: inv-batch-256-1786716000. On the perm-inv-merge 30.560
    // keeper. The fused path already inverts concat(d0,d1) once per
    // chunk. Doubling INV_BATCH halves Montgomery setups and keeps
    // the invert elementwise-identical. Single-challenge INV_BATCH
    // (unused in production) stays 128.
