...
>(
    ...
    // The two challenge columns own separate quotient buffers and independent
    // serial Z recurrences. Convert them concurrently while preserving their
    // challenge-major order in the returned vector.
