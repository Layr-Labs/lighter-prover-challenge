...
mod quotient_layout_tests {
    ...
    /// layout. The selected values are connected to embedded constant oracles;
    /// one prove call compares the combined Metal quotient with a full CPU
    /// recomputation over identical retained LDE columns and challenges, then
