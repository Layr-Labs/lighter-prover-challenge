                    ...
                    for (t, &x) in xs.iter().enumerate() {
                        ...
                        for chunk in 0..num_chunks {
                            ...
                            for j in start..end {
                                ...
                                // Goldilocks FMA: a+b*c+d ≡ multiply_accumulate(a,b,c)+d
                                // (same identity as vanishing_poly::permutation_factor_fma).
                                numerator_0 *=
                ...
                for (t, &x) in xs.iter().enumerate() {
                    ...
                    for chunk in 0..num_chunks {
                        ...
                        for j in start..end {
                            let wire_value = witness.get_wire(i, j);
                            numerator_product *=
                                wire_value.multiply_accumulate(beta_k_is[j], x) + gamma;
                            denominator_product *=
                                wire_value.multiply_accumulate(beta, s_sigmas[j]) + gamma;
                        }
