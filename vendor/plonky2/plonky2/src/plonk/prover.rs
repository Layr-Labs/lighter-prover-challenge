...
>(
    ...
    {
        // All three GPU producers use the same point-major quotient layout.
        // Accumulate them in their historical order while walking the CPU
        // result once, instead of performing one full read/modify/write pass
        // (and one denominator-table read) per completed Metal job.
        // Ranked redraw: 66f2f79a verified 5/5 proofs in the recurring slow
