    ...
    quotient_values
        ...
        .for_each_init(
            ...
            |scratch, (batch_i, (quotient_values_batch, xs_batch))| {
                ...
                // Keep the CPU contribution as a numerator. Every successful
                // Metal family below produces a numerator over the same Z_H,
                // so the common inverse is applied once in the final scatter.
            },
        );
