...
pub(crate) fn eval_vanishing_poly_base_batch<F: RichField + Extendable<D>, const D: usize>(
    ...
    if permutation_products_offloaded {
        ...
        if num_challenges == 2 && n > 0 {
            ...
            for k in 0..n {
                scratch.denominator_values[k] = res_out[k * 2];
                scratch.denominator_values_second[k] = res_out[k * 2 + 1];
            }
            ...
            for k in 0..n {
                res_out[k * 2] = scratch.denominator_values[k];
                res_out[k * 2 + 1] = scratch.denominator_values_second[k];
            }
