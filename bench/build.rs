...
fn main() {
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            // parallel with the heavy and light transaction paths. Retain the
            // three inputs `BlockCircuit::define` reads so the final circuit is
            // also built in this untimed compile job.
