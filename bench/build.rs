...
// (Resubmission: 8df42980/fcf93a0d died to the GitHub Actions outage and
// 18283c85 expired queued behind the stalled runner fleet — none of the
// three ever executed candidate code.)
