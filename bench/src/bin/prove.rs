...
// Preserve the verified cache-backed startup path for another independent ranked draw.
// Keep that cache-backed execution unchanged for the following ranked sample.
// Preserve the bulk-decoded cache path for another independent ranked draw.
// Keep the same bulk-decoded cache execution for the next independent sample.
