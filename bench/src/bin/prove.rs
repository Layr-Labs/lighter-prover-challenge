...
fn main() {
    ...
    // Restore the previously-promoted setup overlap (e595ac3 / rawqubit):
    // fixture parse and embedded circuit load are independent and both sit on
    // the scored process lifetime. The NEON-FFT promotion (40f41af) dropped
    // this join when it rewrote prove.rs; restore it without touching any
    // proof-path scheduling, Metal policy, or field arithmetic.
