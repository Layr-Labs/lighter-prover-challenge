...
// 46 warming embedded pages, 47 loading circuits, 49 proving, 50 writing
// proof — deaths at 300/360/420/480/600/660 s respectively.
...
fn main() {
    ...
    api::warm_embedded_caches();
    api::set_worker_phase(47);
