...
/// Circuit definition and witness generation recurse deeply enough to overflow Rayon's default
/// worker stack once that work happens off the main thread, so size the global pool explicitly.
