...
fn main() {
    ...
    // Required archive hits gate only context readiness. Optional kernels are
    // ordinary asynchronous lowers from the same retained target15 library and
    // deliberately do not participate in this completion check.
