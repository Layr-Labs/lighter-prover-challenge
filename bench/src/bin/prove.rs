...
/// Return the same top-level JSON object with the transaction array replaced
/// by an empty one. The unchanged full serde parse remains authoritative; this
/// compact view exists only because the pre-execution witness does not read
/// transactions and can therefore start while the full transaction array is
/// being decoded.
...
// Transparent official-host redraw marker: jacklightina-20260815-0635.

// Transparent Z-join official-host redraw marker: jacklightina-20260815-0715.

// Final transparent Z-join redraw marker: jacklightina-20260815-0730.
