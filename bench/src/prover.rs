...
// accumulator + spine-backlog accounting fix), sample 2. Sample 1 (73eca59)
// drew 25.51 slow-class — third consecutive slow-runner assignment for the
// archive line (25.69, 25.53, 25.51); mechanism-uninformative, re-rolling.
