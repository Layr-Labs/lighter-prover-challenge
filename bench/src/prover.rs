...
// Series draw marker: v16, sample 2 — the priced free-rider package on the
// 30.66 frontier: deferred-pipeline start-order (0 stalls 6/6, 0.05-0.08 s),
// first-witness hoist (row #3b deleted, 0.04-0.068 s), batched x4 FRI PoW
// grinding (1.17-1.19x measured, 0.071-0.084 s). Package 0.16-0.21 s/worker.
// Series ledger: s1 aeefaa9 drew 26.48 slow-class — above every catalogued
// slow-class control draw (band 25.4-26.2), consistent with the package shift.
