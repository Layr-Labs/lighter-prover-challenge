...
// Ranked redraw: quotient-queue correction, sample 2 after a 97.34 s slow-host draw.
// Ranked redraw: quotient-queue correction, sample 3 after a 96.00 s slow-host draw.
