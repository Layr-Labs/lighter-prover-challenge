...
// accumulator + spine-backlog accounting fix), sample 5. Archive-line draw
// ledger: 25.69, 25.53, 25.51, 25.80, 25.97, 29.99(fast, below frontier band) —
// sample 5; first fast draw undershot the 30.4-30.65 frontier fast band.
