...
// A window of 2 starves the strictly sequential chain consumer whenever one
// chunk proof runs long; 3 keeps one extra completed proof buffered ahead of
// it for ~0.6 GB more peak retention, well inside the 48 GB runner. 4 was
// measured and regressed, so 3 is the measured optimum.
