...
// Series draw marker: v16, sample 3 — the priced free-rider package on the
...
// Series ledger: s1 26.48, s2 26.19 (slow-class; control mean ~25.8, band top
// 26.2). Series mean +0.53 over control — tracking the predicted +0.3-0.4 shift.
