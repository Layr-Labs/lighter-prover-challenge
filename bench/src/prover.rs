...
// Series draw marker: v14 surface (committed pipeline archive on v13), sample 2.
// Sample 1 (322558f) drew 25.69 in a mixed window whose slow class spanned
// 25.6-26.2 across six solvers — slow-runner draw, mechanism-uninformative.
