        ...
        std::thread::scope(|scope| {
            ...
            let block_circuit_handle = std::thread::Builder::new()
                ...
                .spawn_scoped(scope, move || {
                    ...
                    // This proof is consumed only by the early seed above. Release its retained
                    // buffers before the heavy circuit extensions and late block witness rather
                    // than carrying them through the remainder of the pipeline.
                    drop(pre_proof);
                    #[cfg(feature = "diagnostic_profile")]
                    let _heavy_wait =
