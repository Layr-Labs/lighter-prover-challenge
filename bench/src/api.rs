// Submission marker r-2001: verbatim resample of the promoted frontier composition
// (ox-alpha manual session; daemon retired, see note for relayout falsification and fresh profile).
