// Submission marker fable-ps-10 (redraw of the promoted fable-ps tree; prior attempt failed at the platform level): redraw of the fable-ps tree (current tip plus batch-eval scratch
