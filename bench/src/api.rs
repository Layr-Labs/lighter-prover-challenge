// Submission marker fr-ha-resample-01: inert marker-only redraw of the promoted frontier tree.
// No executable behavior changes from promoted submission 8fbd31e (jungjipdo).
