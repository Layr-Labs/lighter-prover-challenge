// Submission marker fable-ps-02: restored quotient-merge chunking, NEON even-column
// deinterleave and zero-copy FRI fold from the promoted 4d64f11b lineage, plus
// batch-eval scratch reuse in the comparison/u16 arithmetic gate generators.
