// Submission marker fable-ps-04: redraw of the fable-ps tree (current tip plus batch-eval scratch
...
// Marker bumped only for a fresh submission hash; no behavior change vs fable-ps-03.
