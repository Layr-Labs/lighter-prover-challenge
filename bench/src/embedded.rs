...
static PRE_BLOB: &[u8] = include_bytes!("../embedded/pre.embed");
static HEAVY_TX_BLOB: &[u8] = include_bytes!("../embedded/heavy_tx.embed");
static HEAVY_CHAIN_BLOB: &[u8] = include_bytes!("../embedded/heavy_chain.embed");
static LIGHT_TX_BLOB: &[u8] = include_bytes!("../embedded/light_tx.embed");
static LIGHT_CHAIN_BLOB: &[u8] = include_bytes!("../embedded/light_chain.embed");
