...
/// Generated offline on a GitHub-hosted arm64 runner for macOS 15 deployment
/// and the exact eleven-pipeline roster, then reduced to the M4 `g16g`/`g16s`
/// slices. Runtime `FailOnBinaryArchiveMiss` probes remain authoritative.
pub const EXPECTED_BYTES: Option<u64> = Some(1_372_432);
pub const EXPECTED_SHA256: Option<&str> =
    Some("48aa9a35b8cb6cc0ffca7cb4bbd84ab29d71ec3877ce5bc7129e69d12d4c0f70");
